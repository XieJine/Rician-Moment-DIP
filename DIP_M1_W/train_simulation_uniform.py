...
# bp = True
# ii = np.load('outputs/DIP_M1_W/generate_data_2/iterations/level_5/i.npy')
# i = np.load('outputs/DIP_M1_W/generate_data_2/iterations/level_5/i.npy')
# i = i-(i%40)
# LR=0.01*0.9**(i//2000)

# trained_model_name = 'outputs/DIP_M1_W/generate_data_2/trained_model/level_5/epoch_' + str(i) +'.pt'
# trained_model_name_last = 'outputs/DIP_M1_W/generate_data_2/trained_model/level_5/epoch_' + str(i-1) +'.pt'
...
# psrn_out_list = list(np.load('outputs/DIP_M1_W/generate_data_2/psnr_rmse/level_5/psnr_level_5.npy'))
# total_loss_list = list(np.load('outputs/DIP_M1_W/generate_data_2/psnr_rmse/level_5/loss_level_5.npy'))
# rmse_out_list = list(np.load('outputs/DIP_M1_W/generate_data_2/psnr_rmse/level_5/rmse_level_5.npy'))
