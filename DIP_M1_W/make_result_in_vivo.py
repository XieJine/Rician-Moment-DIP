...
epoch = 194120
net_name = 'outputs/DIP_M1_W/1p5T/best_model/b1k5/epoch_'+str(epoch)+'.pt'
save_name = 'outputs/DIP_M1_W/1p5T/best_model/b1k5/fig_'+str(epoch)+'/'
# Output directory for the denoised NIfTI volume.
save_data_path  =  "outputs/DIP_M1_W/1p5T/denoised/"
