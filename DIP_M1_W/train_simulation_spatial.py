...
bp = False
if bp:
    ii = np.load('outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/iterations/level_3_5/i.npy')
    i = np.load('outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/iterations/level_3_5/i.npy')
    i = i-(i%40)
    LR=0.01*0.9**(i//2000)

    trained_model_name = 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/trained_model/level_3_5/epoch_' + str(i) +'.pt'
    #trained_model_name_last = 'outputs/DIP_M1_W/sigma_Ablation/trained_model/level_5_sigma7/epoch_' + str(i-1) +'.pt'
    ...
    psrn_out_list = list(np.load('outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/psnr_rmse/level_3_5/psnr_level_3_5.npy'))
    total_loss_list = list(np.load('outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/psnr_rmse/level_3_5/loss_level_3_5.npy'))
    rmse_out_list = list(np.load('outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/psnr_rmse/level_3_5/rmse_level_3_5.npy'))
...
# Output from the previous iteration.
    ...
    path_main_1 = 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/psnr_rmse/level_3_5/'
    if not os.path.exists(path_main_1):
        os.makedirs(path_main_1)
    path_main_2 = 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/iterations/level_3_5/'
    if not os.path.exists(path_main_2):
        os.makedirs(path_main_2)
    path_main_3 = 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/result/level_3_5/'
    if not os.path.exists(path_main_3):
        os.makedirs(path_main_3)
    path_main_4= 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/loss/level_3_5/'
    if not os.path.exists(path_main_4):
        os.makedirs(path_main_4)
    path_main_5 = 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/trained_model/level_3_5/'
    if not os.path.exists(path_main_5):
        os.makedirs(path_main_5)
    path_main_6 = 'outputs/DIP_M1_W/Spatial_transformation_noisy_truenoise/model/level_3_5/'
    if not os.path.exists(path_main_6):
        os.makedirs(path_main_6)



    psnr_name =  path_main_1+'psnr_level_3_5.npy'
    psnr_noisy_name =  path_main_1+'psnr_noise_level_3_5.npy'
    # mse_name = 'outputs/DIP_M1_W/generate_data_2/psnr_rmse/level_5/mse_level_5.npy'
    rmse_name =  path_main_1+'rmse_level_3_5.npy'
    loss_name =  path_main_1+'loss_level_3_5.npy'
    ...
    # if (i+1)%show_every == 0:
    #     model_name_last = 'outputs/DIP_M1_W/generate_data_2/trained_model/level_5/epoch_' + str(i) +'.pt'
