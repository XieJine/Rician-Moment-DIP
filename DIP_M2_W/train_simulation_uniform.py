...
# bp = True
# ii = np.load('outputs/DIP_M2_W/generate_data/iterations/level_5/i.npy')
# i = np.load('outputs/DIP_M2_W/generate_data/iterations/level_5/i.npy')
# i = i-(i%40)
# LR=0.01*0.9**(i//2000)

# trained_model_name = 'outputs/DIP_M2_W/generate_data/trained_model/level_5/epoch_' + str(i) +'.pt'
# trained_model_name_last = 'outputs/DIP_M2_W/generate_data/trained_model/level_5/epoch_' + str(i-1) +'.pt'
...
# psrn_out_list = list(np.load('outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/psnr_level_5.npy'))
# total_loss_list = list(np.load('outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/loss_level_5.npy'))
# rmse_out_list = list(np.load('outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/rmse_level_5.npy'))
...
# Output from the previous iteration.
    ...
    RMSE_noisy = np.sqrt((np.sum((out_np_nonskull-img_noisy_np_nonskull)**2))/(mask_num_npy*16))
    ...
    psnr_name = 'outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/psnr_level_5.npy'
    psnr_noisy_name = 'outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/psnr_noise_level_5.npy'
    # mse_name = 'outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/mse_level_5.npy'
    rmse_name = 'outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/rmse_level_5.npy'
    loss_name = 'outputs/DIP_M2_W/generate_data/psnr_rmse/level_5/loss_level_5.npy'
    ...
    iteration_name = 'outputs/DIP_M2_W/generate_data/iterations/level_5/i.npy'  
    ...
    if  i % show_every == 0:
        ...
        model_name_ = 'outputs/DIP_M2_W/generate_data/model/level_5/epoch_' + str(i%(show_every*2)) +'.pt'
        ...
        if  i!=0 and i!=show_every and psnr_noisy_array[i-show_every+1:i+1].min() - psnr_noisy_array[i-2*show_every+1:i-show_every+1].min() < -0.05:  
            ...
            if t >0:
                i = i-show_every
                net.load_state_dict(torch.load('outputs/DIP_M2_W/generate_data/model/level_5/epoch_' + str(i%(show_every*2)) +'.pt'))
                total_loss = torch.load('outputs/DIP_M2_W/generate_data/loss/level_5/epoch_' + str(i%(show_every*2)) +'.pt')
                total_loss.backward()
