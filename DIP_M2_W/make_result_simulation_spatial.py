...
if Matrix:
    ...
    Mrtrix_output_file= Mrtrix_output_path +'SSIM_PSNR_results'+str(epoch)+'.csv'
    headers = ["Metric","all" , "b0", "dwi" , "noisy_b0", "noisy_dwi"]
    rows = [
            ["PSNR", PSNR_out, PSNR_out_b0,PSNR_out_dwi,PSNR_out_noisy_b0,PSNR_out_noisy_dwi],
            ["SSIM",  SSIM_out,SSIM_out_b0,SSIM_out_dwi,SSIM_out_noisy_b0,SSIM_out_noisy_dwi]
            ]
